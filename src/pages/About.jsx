        ...
        <div className="min-h-screen w-full flex flex-col space-y-10 justify-center items-center">
            ...
            <div className="about-celestia w-full px-4 md:px-8 lg:px-16" id="about">
                <div className="what-logo flex justify-center m-10">
                    <img className="celestia-logo-about object-fill w-[200px] md:w-[300px]" src={celestia_logo} alt="Celestia Logo" />
                </div>
                <div className="what-text text-center flex justify-center text-md md:text-xl font-semibold">
                    <div className="max-w-4xl px-5 break-words">
                ...
                {/* Footer */}
                <div className="footer w-full flex justify-around items-center relative top-[-20px] md:top-0 py-10 bg-black rounded-t-[30px] shadow-[0_0px_15px_rgba(0,0,0,0.62)] mt-20">
                    <Footer />
                </div>
